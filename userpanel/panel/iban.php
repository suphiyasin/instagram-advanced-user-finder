                     ...
                     <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">Basic Form</h6>
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Iban Giriniz (TR0000000000000000000000000)</label>
                                    <input type="text" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp">
                                    <div id="emailHelp" class="form-text">Sadece Adres Verir , Her İban Çıkmaz
                                    </div>
                                </div>
