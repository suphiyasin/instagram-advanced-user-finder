<?php
$_SESSION['mailb'] = "hazirdegil";
$_SESSION['dmb'] = "hazirdegil";
 $_SESSION['messb'] = "hazirdegil";
 include("menubar.php");
?>
<div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.php" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"><i class="fa fa-user-edit me-2"></i>Suphi - Arda</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    <a href="index.php" class="nav-item nav-link active"><i class="fa fa-tachometer-alt me-2"></i>Dashboard</a>
					 <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Collector</a>
...
?>
						   		 ...
						   		 <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Scanner</a>
						     <div class="dropdown-menu bg-transparent border-0">
<?php
include("sis.php");
...
?>
						   	   		 ...
						   	   		 <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Sender</a>
						     <div class="dropdown-menu bg-transparent border-0">
<?php
include("sis.php");
